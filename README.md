...
{
    "dependencies": {
        "@roncli/node-minify": "roncli/node-minify#v1.3.2"
    }
}
```
...
### v1.3.2 - 4/19/2026
* Fixed a bug with case sensitivity where placeholder attributes in HTML embedded in JavaScript template strings were not being correctly recognized.
* Package updates.

### v1.3.1 - 3/28/2026
* Fixed issues with nested minification.
* Package updates.
